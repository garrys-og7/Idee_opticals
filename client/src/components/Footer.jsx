...
export default function Footer() {
  ...
  const footerLinks = {
    shop: ['Men\'s Frames', 'Women\'s Frames', 'Kids\' Frames', 'Sunglasses'],
    company: ['About Us', 'Our Story', 'Careers', 'Contact'],
    support: ['Customer Service', 'Shipping', 'Returns', 'Warranty'],
      ...
      <div className="mx-auto max-w-7xl px-4 py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <h3 className="mb-4 text-2xl font-light text-white">Idée Opticals</h3>
            <p className="mb-6 max-w-md text-sm leading-relaxed text-neutral-400">
              Crafting premium eyewear with precision, style, and uncompromising quality. 
              Experience the perfect vision of elegance.
            </p>
        ...
        <div className="mt-12 border-t border-neutral-800 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm text-neutral-400">
              © {currentYear} Idée Opticals. All rights reserved.
            </p>
            <div className="flex gap-6">
              {footerLinks.legal.map((link, index) => (
                <a key={index} href="#" className="text-sm text-neutral-400 transition-colors hover:text-white">
                  {link}
                </a>
              ))}
            </div>
